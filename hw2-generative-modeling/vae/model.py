...
class Encoder(nn.Module):
    ...
    def __init__(self, input_shape, latent_dim):
        ...
        # After 3 stride-2 convs: 32 -> 16 -> 8 -> 4, so output is 256 x 4 x 4
...
class VAEEncoder(Encoder):
    def __init__(self, input_shape, latent_dim):
        ...
        # 2*self.latent_dim
        ##################################################################
        # Output both mu and log_std (2 * latent_dim)
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim, output_shape):
        ...
        ##################################################################
        # Base size is 4x4 with 256 channels (after encoder)
    ...
    def forward(self, z):
        ...
        ##################################################################
        z = self.fc(z)
        z = z.view(z.size(0), *self.base_size)  # Reshape to (batch, 256, 4, 4)
        z = self.deconvs(z)
        return z
        ##################################################################
        #                          END OF YOUR CODE                      #
